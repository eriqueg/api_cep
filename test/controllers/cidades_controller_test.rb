...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference('Cidade.count') do
      post cidades_url, params: { cidade: { estado_id: @cidade.estado_id, ibge: @cidade.ibge, nome: @cidade.nome } }, as: :json
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { estado_id: @cidade.estado_id, ibge: @cidade.ibge, nome: @cidade.nome } }, as: :json
    assert_response 200
  end
